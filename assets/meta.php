...
<head>
  ...
  <meta name="description" content="Jobinpal Enterprises - Building the digital culture in Nigeria."/>
  <meta name="google-site-verification" content="uTLC552i2tTWAsunj4V1DhV026-3e9tEsaKB7urieMU" />
    ...
    <script type="application/ld+json">
        {
          ...
          "@type": "Organization",
          "url": "http://jobinpalent.com.ng",
          "logo": "http://jobinpalent.com.ng/img/favicon.png",
          "name": "Jobinpal",
          "sameAs": [
          "http://www.facebook.com/jobinpalenterprisesng",
          "http://instagram.com/jobinpalenterprisesng",
          ],
          "contactPoint": [
          { 
            "@type": "ContactPoint",
            "telephone": "+234 703 447 4485",
...
<!-- /end Google Search Structured Data -->
  ...
  <!-- GOOGLE FONT -->
  <link href="../../../fonts.googleapis.com/css15fb?family=Muli:200,300,400,600,700,800,900" rel="stylesheet">
  ...
  <link href="../../../fonts.googleapis.com/css92b4?family=Herr+Von+Muellerhoff" rel="stylesheet">

  <!-- CUSTOM CSS -->
  <link href="css/style.css" rel="stylesheet">

  <!-- JOBINPAL ENTERPRISES CSS -->
  <link href="css/je.css" rel="stylesheet">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-108073565-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-108073565-1');
  </script>
